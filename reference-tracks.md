...
Like also use MSED to just do a mono take of the song and you'll immediately hear how the stereo adds to the bigness of the song. Oppositely, usr MSED before a SPAN, mute the mids and then you can see what frequencies the stereo width (like, how low it goes). Toggle it and see if side mute vs. full song changes stuff in the SPAN frequency spectrum or not.
