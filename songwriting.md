...
Same with instrumentation, if you are using a certain set of instruments and sounds, there is no reason to go and start throwing out your full pallet of sounds just because you want to make a verse that sounds different (and less energy) than the chorus. There is no need for that. Simply look at the pads and plucks and fx you have and see how you can reuse those sounds in your verse and use automation and synth macros (like making stuff more staccato or less high-endy or less bass-y) to make them indeed sound more like verse. Again, as I said in a previous tip too, the more you reuse your sound the more cohesive your song sounds. That doesn't mean you can't use different patches as chords in your verse or a different lead as chorus or contrast. Again, watch references for that, but just know that simply fx changes automation and different composition and different layering (or less layering) or leaving sounds out stuff can make your same sounds be used as a verse like as it was in a chours. Of course, you can throw in some distinct verse and chorus sounds but reference to see how they do it.
