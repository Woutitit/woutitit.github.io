...
3. [Fill up mix but do it properly](#fill-up-mix-but-do-it-properly)
4. [Turn down mix to hear better](#turn-down-mix-to-hear-better)
5. [Mix with master off](#hi)
6. [There are multiple ways of achieving (basically) the same thing](#hi)
7. [A professional track has dimensions](#hi)
8. [Keep timbres and harmonics in mind](#keep-timbre-and-harmonics-in-mind)
9. [Don't be afraid to transpose key](#dont-be-afraid-to-transpose-keys)
10. [Take care of the stereo image](#take-care-of-the-stereo-image)
11. [Key to full and clean mix](#key-to-full-and-clean-mix)
12. [Bus stuff that fits together](#bus-stuff-that-fits-together)
13. [Mixing can solve composition and vice versa](#mixing-can-solve-composition-and-vice-versa)
14. [Small moves on a lot of tracks add up](#small-moves-on-a-lot-of-tracks-add-up)
15. [Strive for tonal balance](#strive-for-tonal-balance)
16. [Limit the duration of a mixing session](#limit-the-duration-of-a-mixing-session)
17. [Don't be afraid of low-end](#dont-be-afraid-of-low-end)
18. [Don't be afraid to tame high-end](#dont-be-afraid-to-tame-high-end)
19. [3-stage mixing and mastering](#3-stage-mixing-and-mastering)
20. [Have a reference track](#have-a-reference-track)
21. [Mixing is about prioritization](#mixing-is-about-prioritization)
22. [Fatten a mix through layering and FX](#fatten-a-mix-through-layering-and-fx)
23. [Increase and work transients](#increase-and-work-transients)
24. [Mastering 101](#mastering-101)
25. [Sound selection vs. processing](#sound-selection-vs-processing)
26. [Don't use presets as-is](#dont-use-presets-as-is)
27. [Add a soft clipper before master limiter](#add-a-soft-clipper-before-master-limiter)
28. [Consider splitting bass and sub bass](#consider-splitting-bass-and-sub-bass)
29. [The further back a sound the sloppier it can be](#the-further-back-a-sound-the-sloppier-it-can-be)
30. [Audition everything in context of the mix](#audition-everything-in-context-of-the-mix)
31. [Mixing for loudness](#mixing-for-loudness)
32. [Don't obsess over LUFS and RMS](#dont-obsess-over-lufs-and-rms)
33. [Mind the order of your FX](#mind-the-order-of-your-FX)
34. [Use visual feedback](#use-visual-feedback)
35. [Make your mix translate](#make-your-mix-translate)
...
*Intermezzo: This is also why you shoulnd't worry about having background stuff high-passed or low-shelved as it fits the vibe better or mix or section better. Again, tonal stuff not there to fill up the highs. Of course, in terms of translatability and (volume) continuity of the song (especially on speakers) you still want some high/mids in there (whether that's perc and/or some atmo, FX and/or some tonal stuff) even in quiet intimate sections. But again, don't worry about the low pass of tonal stuff, even like your main elements coming in with the low pass or being shelved. Like, since it's mids and you still have lows so it won't make your mix less strong and neither less bright if you have low-pass some/main elements (I mean of course a little bit but you still have drums or some high-end perc or whatever especially in the drop). It doesn't matter anyway. Now, of course, there are exceptions (such as hard hitting bass in EDM) but those are pretty obvious (see articles above I've linked)*. It's just what fits the mix as often you may want to low-pass as too much bright sounds may simply clash. Or maybe it simply doesn't fit the vibe and/or section.*

*Or, also why you shouldn't worry too much about making space with EQ (mainly in the mids) that your mix is going to be weaker or stronger. Like, that's where the sub and the brights are for and EQing your tonal stuff isn't in those ranges anyway so don't worry too much about it. Of course, once you start high passing and shelving (a lot) in the lower and higher areas you'll want to like be a bit wary that you don't lose too much warmth or brightness in the sound but don't worry about losing strongness too too much.*
...
Now, we want this same *perceived* loudness in our mix because having too much high-end will make us turn up the song for the bass but we can't since the high-end volume will pierce our ears. Same with when there is too much lows or mids. We want a nice flat balance so that we can perceive all ranges well without the need for turning the radio louder or quieter to hear stuff better.

*Intermezzo: So how does tonal balance look like? Well, SPAN, just like PEQ2, uses a 4.5db/oct pivot slope which equals to pink noise and equals to how we perceive sound. Therefore, when stuff looks flattish on SPAN you know you have a fairly balanced mix. You can look at pink noise through SPAN for exmaple and see that it's straight. Then you can look at white noise in span and see that it goes up, this is because white noise is equal loudness but not equal perceived loudness. It's therefore not super balanced but as we'll see in a bit, heavy EDM is usually brighter and may look a bit more like white noise on SPAN.*
