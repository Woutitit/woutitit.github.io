...
That said, usually endings of sections are more cluttered then others because want a burst of energy to announce the section is ending. This can be a fill, this can be a fill and a bass line getting briefly funkier this can be a shitton of things it depends on the song. But the point is while it may in the literal sense be cluttered it actually doesn't sound cluttered but sounds more like a transition because it's brief enough for the listener to not notice that it's cluttered because the clutter is not there for too long. So yeah, don't take delete and unclutter for everything. You have to know when and where you can/have to be more cluttered.
