...
## Listen to songs before producing
...
## Notice how pros really don't need much time
You'll notice that a lot of pros can duke out a pretty decent song (or even finish) in the timespan of between 5-20hrs total. So yeah, for a single song that isn't really that long where currently my struggle is a lot of times 20-40+ hours on shit that's really bad so you think making stuff is complex and convoluted.

No, when you're workflow starts being good, you start to know you genre(s), you have good sounds, presets and samples you know for occassion and you sprinkel some discipline into that, then eventually you'll be able to duke out songs like that in that "little" amount of time.

Of course pros afterwards will spent hours mixing, adding sound fx and mastering still but the general song often can get laid down pretty quickly. Of course this can very too.

## Focus on the 80%
Focus on making your songs 80% as good as it can be. Often that 80% is 20% of your time will that last 20% is 80% time). Like that last 20% are all the little mixing things (like the flawless mastering, the subtle yet needed saturation, etc.) that will make the track sound pro instead of semi-pro. Though, for the end-listener the mix result won't be that hearable either way. 
...
## Plan, research and use references (and loops and presets)
...
## To get a big thing done, focus on small achievements not the big thing
...
## Refrain from replaying and opening your DAW without a purpose
Try to refrain from replaying unfinished songs, or parts of songs, even as much as you like to hear those parts. You'll get bored with it and it will make you not want to produce track anymore. Even with songs that are finished, the ones on the internet, I have this that I move on from them. Therefore, to keep the hunger, refrain from replaying your stuff too much, even if you really want to. You'll notice you'll fight the urge for a little bit but once you're doing other stuff you forgot about it. In the production stage only try to replay with a purpose. Same for opening your DAW, don't open your DAW, play the song, just to then close the DAW and have not done any work. Or replay the song a million times for a small change, etc. Again, it requires some discipline but you'll really want this if you want to finish tracks.
